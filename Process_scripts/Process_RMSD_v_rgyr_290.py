...
datafiles = glob.glob('B_State/*/rgyr_290/without_ter.xvg') 
index=0
for datafile in datafiles : 
    molec = datafile.split('/')[1]
    datafile2 = "B_State/%s/rmsd_290/without_ter.xvg"%molec
    ...
    index +=1
fig.savefig('figures/rmsd_v_rgyr_290.png',format='png') 
